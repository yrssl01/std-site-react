...
function Header() {
  ...
  return (
    <nav className="bg-white border-gray-200 text-[#101014] sticky 2xl:static top-0 px-20 py-6 md:py-10 mx-auto">
      <div className="mx-auto flex items-center justify-between max-w-screen-3xl">
        ...
        <ul className={`flex ml-auto gap-8 list ${isMenuOpen ? 'active' : ''}`}>
          <li>
            <Link
              to="/"
              onClick={closeMenu}
              className="transition duration-300 hover:text-[#b1b1b1]"
            >
              Главная страница
            </Link>
          </li>
